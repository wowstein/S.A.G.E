...
CREDENTIALS_FILE = "D:\SAGE\SAGE_Elysium\credentials.json"
...
class AddEventToCalendar(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        new_time = datetime.strptime(f'{time}', '%d/%m/%y %H:%M:%S')
...
class ClassifyUser(Action):
    ...
    def run(
        ...
        clf = joblib.load("D:\SAGE\SAGE_Elysium\SAGE_RECOMMENDER.joblib")
